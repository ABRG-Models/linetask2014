...
and S1 Video). It requires participants to move a
...
\begin{figure}[htb!]
\centering
%\includegraphics[width=1\textwidth]{./figures/Fig2.tiff}
...
% measured either!
A list of the reasons for omitting events is given in S2 Appendix.
...
latency measurements for each individual. For details and code, see S3
Appendix and S4 Code.
%
%(see the method
...
\begin{figure}[htb!]
\centering
%\includegraphics[width=0.7\textwidth]{./figures/Fig11.tiff}
\caption[Mean latencies vs. distance] {`Moving bin' mean latencies to
...
\begin{figure}[htb!]
\centering
%\includegraphics[width=0.7\textwidth]{./figures/Fig12.tiff}
...
\label{linetaskvid}
{\bf S1 Video. A video of the line task:} \url{https://www.youtube.com/watch?v=9o3AKdDq9aE}

\subsection*{Supplementary text}

\label{linetask_omitreasons}
{\bf S2 Appendix. A list of omit reasons.} A list of the reasons for which it may
...
\paragraph{S3 Appendix. Statistical analysis.} PDF version of statistical analysis
ipython notebook. See file Anova.pdf

\subsection*{Data and software}

\label{linetaskrepo}
{\bf S4 Code. Code and data repository.} The data from this study and the
