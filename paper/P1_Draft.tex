...
\begin{equation}\label{eq:tau_target}
  T_t = N(\mu=1.6,\sigma^2=0.636)~\text{seconds}
\end{equation}
%
...
\begin{equation}\label{eq:tau_distractor_async}
  T_d = N(\mu=0.8,\sigma^2=0.158)~\text{seconds}
\end{equation}
...
sample mean, we made 2013 bootstrap resamples of the data with
replication, computing the mean each time. The estimate of the
standard error is the standard deviation of the resampled means.

\begin{figure}[htb!]
\centering
\includegraphics[width=0.7\textwidth]{./figures/data_density_altmethod.png}
\caption[Latency measurement PDF] {Probability density function
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.7\textwidth]{./figures/movingbin_latvslastdist_async.png}
\caption[Mean latencies vs. distance] {`Moving bin' mean latencies to
...
% Reviewer 1 suggests to discuss delay. this was line 545.
Within the framework of sequential evidence
