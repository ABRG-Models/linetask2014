...
\hline
\textbf{\DIFaddFL{Condition}} & \textbf{\DIFaddFL{Mean (ms)}} & \textbf{\DIFaddFL{Std. Dev.}} & \textbf{\DIFaddFL{Std. Err.}} \\ [0.5ex]
\hline
...
\DIFaddFL{AD }& \DIFaddFL{345.0 }& \DIFaddFL{79 }& \DIFaddFL{1.8 }\\ [1ex]
\hline
...
\DIFaddFL{AD }& \DIFaddFL{341.6 }& \DIFaddFL{71 }& \DIFaddFL{2.0 }\\ [1ex]
\hline
\end{tabular}
...
\hline
\textbf{\DIFaddFL{Conditions}} & \textbf{\DIFaddFL{Difference (ms)}} & \textbf{\DIFaddFL{SE}} & \textbf{\DIFaddFL{Z-score}} & \textbf{\DIFaddFL{t-test p-value}} \\ [0.5ex]
\hline
...
\DIFaddFL{SD/AD }& \DIFaddFL{8.92 }& \DIFaddFL{2.24 }& \DIFaddFL{3.98 }& \DIFaddFL{0.000015 }\\ [1ex]
\hline
...
\DIFaddFL{SD/AD }& \DIFaddFL{11.6 }& \DIFaddFL{2.45 }& \DIFaddFL{4.73 }& \DIFaddFL{\textless1$\times$10$^{-3}$ }\\ [1ex]
\hline
\end{tabular}
...
\DIFdelFL{345.0 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{79 }\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Non-error}} \DIFaddendFL & \DIFdelbeginFL \DIFdelFL{65 }\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Error}} \DIFaddendFL & \DIFdelbeginFL \DIFdelFL{2.9 }%DIFDELCMD < \\ [%%%
